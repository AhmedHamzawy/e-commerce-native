...
class PayPal {
	...
	// your paypal id
	private $_business = 'ecstacyforcom@gmail.com';
	...
	public function __construct($cmd = '_cart') {
		...
		$this->_return = SITE_URL.'/'.G_PATH."/?page=ipn";
		$this->_cancel_payment = SITE_URL.'/'.G_PATH."/?page=cancel";
		$this->_notify_url = SITE_URL.'/'.G_PATH."/?page=ipn";
		$this->_log_file = SITE_URL.'/'.G_PATH."log".DS."ipn.log";
