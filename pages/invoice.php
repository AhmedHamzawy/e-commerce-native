...
<div id="wrapper">
	...
	<div style="width:50%;float:left">		
		<p><strong>To:</strong>
		<?php echo $client->first_name." ".$client->last_name; ?><br />
		<?php echo $client->address_1; ?><br />
		<?php echo !empty($client->address_2) ? $client->address_2.'<br />' : null; ?>
		<?php echo $client->town; ?><br />
		<?php echo $client->county; ?><br />
		<?php echo $client->post_code; ?><br />
		<?php
